...
router.post('/login', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, loginId, password, company, isMatch, token, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, loginId = _a.loginId, password = _a.password;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 4, , 5]);
                return [4 /*yield*/, Company.findOne({ loginId: loginId })];
            case 2:
                company = _b.sent();
                if (!company) {
